...
//     "India":"Indian rupee"
// }
// map all countries and currencies like above from restcountries database
...
var rest_countries=[
  ...
  // rest_countries.forEach(country => console.log(country.name, country.currencies[0].name))

  // rest_countries.forEach(country => my_data [country.name] = country.currencies[0].name)

  // map country name and population

  rest_countries.forEach(country=>my_data[country.name]=country.population)
  console.log(my_data);